...
import com.cry.ecom.Service.Product.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> getProductByCategoryAndBrand(@RequestParam String productCategory,
        ...
        try {
            List<Product> products = productService.getProductsByCategoryAndBrand(productCategory, brand);
            if (products.isEmpty()) {
                return ResponseEntity.status(NOT_FOUND).body(new ApiResponse("No products found ", null));
            }
            List<ProductDto> convertedProducts = productService.getConvertedProducts(products);
    ...
    public ResponseEntity<ApiResponse> findProductsByCategory(@PathVariable String productCategory) {
        try {
